...
class GutenbergBlockParser
{
     ...
     * and returns whether to proceed eating more tokenss
     *
        ...
        switch ($token_type) {
            ...
            case 'void-block':
                ...
                if ($stack_depth === 0) {
                    ...
                    $this->output[] = (array) new GutenbergBlockParserBlock($block_name, $attrs, [], '', []);
                ...
                $this->add_inner_block(
                    new GutenbergBlockParserBlock($block_name, $attrs, [], '', []),
                    $start_offset,
                    $token_length
                );
                $this->offset = $start_offset + $token_length;
     ...
     * @return GutenbergBlockParserBlock freeform block object.
     */
    public function freeform($inner_html)
    {
        return new GutenbergBlockParserBlock(null, [], [], $inner_html, [$inner_html]);
    }
     ...
     * @since 5.0.0
     *
     * @param  GutenbergBlockParserBlock  $block  The block to add to the output.
     * @param  int  $token_start  Byte offset into the document where the first token for the block starts.
     * @param  int  $token_length  Byte length of entire block from start of opening token to end of closing token.
     * @param  int|null  $last_offset  Last byte offset into document if continuing form earlier output.
     */
    public function add_inner_block(GutenbergBlockParserBlock $block, $token_start, $token_length, $last_offset = null)
    {
