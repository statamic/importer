...
class StoreImportTest extends TestCase
{
    ...
    #[Test]
    public function it_stores_a_taxonomy_import_with_a_site()
    {
        $this->setSites([
            'en' => ['locale' => 'en', 'url' => '/'],
            'fr' => ['locale' => 'fr', 'url' => '/fr/'],
    ...
    #[Test]
    public function it_cant_store_a_taxonomy_import_without_a_site_when_multisite_is_enabled()
    {
        $this->setSites([
            'en' => ['locale' => 'en', 'url' => '/'],
            'fr' => ['locale' => 'fr', 'url' => '/fr/'],
        ...
        $this->assertNull(Import::find('categories'));
    }
    ...
    #[Test]
    public function it_stores_a_user_import_without_a_site_when_multisite_is_enabled()
    {
        $this->setSites([
            'en' => ['locale' => 'en', 'url' => '/'],
            'fr' => ['locale' => 'fr', 'url' => '/fr/'],
